          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="py-4">
              <div className="flex items-center gap-2 text-(--blue-300) text-sm mb-4">
                <span>Home</span><span>&gt;</span><span>Fleet</span><span>&gt;</span><span className="text-white">Packer & Mover</span>
              </div>
            ...
            <div className="relative hidden lg:block">
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1600518464441-9154a4dea21b?w=700&h=450&fit=crop" alt="Packers and Movers" className="w-full h-auto object-contain" />
